(function($) {
  ...
  Postcodes.prototype.setDropDown = function(data, postcode) {
    ...
    var dropDown = $('<select />', {id: self.dropdown_id}).addClass(self.dropdown_class);
    ...
    dropDown.appendTo(self.$context).change(function() {
      var index = $(this).val();
      if (index >= 0) {
  ...
  Postcodes.prototype.setErrorMessage = function(message) {
    ...
    }).addClass(this.error_message_class).appendTo(this.$context);
